...
class ScreeningServiceImplementationTest {
    ...
    private final static Screening ENTITY = new Screening(new Movie("How To Train Your Dragon", "animation", 98), new Room("A25", 10, 10), LocalDateTime.of(2024, 12, 10, 8,12));
    ...
    void createScreening() {
        screeningRepository1.save(ENTITY);
        underTest.createScreening(new Movie("How To Train Your Dragon", "animation", 98), new Room("A25", 10, 10), LocalDateTime.of(2024, 12, 10, 8,12));
        List<Screening> screenings = screeningRepository1.findAll();
        List<Screening> screenings1 = screeningRepository.findAll();
        Assertions.assertEquals(screenings, screenings1);
    }
